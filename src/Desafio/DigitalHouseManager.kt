...
class DigitalHouseManager() {var listaAlunos = mutableListOf<Aluno>(); var listaProfessores = mutableListOf<Professor>(); var listaCursos = mutableListOf<Curso>()
        ...
        if(listaCursos.size >= 0){
            for(i in 0 .. listaCursos.size){
                if(listaCursos.get(i).codigo == codigoCurso){
                    ...
                    listaCursos.get(i).professorTitular = professorAdjunto;
